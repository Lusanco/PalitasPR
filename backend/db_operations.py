    ...
    def delete(self, data):
        ...
        for obj in objs_to_delete:
            ...
            if model_name == "Service" and "user_id" in inner_dict:
                ...
                assoc_obj = (
                    session.query(UserServiceAssoc)
                    .filter(
                        UserServiceAssoc.service_id == obj.id,
                        UserServiceAssoc.user_id == inner_dict["user_id"],
                    )
                    .all()
                )
                ...
                assoc_objs = (
                    session.query(UserServiceAssoc)
                    .filter(UserServiceAssoc.user_id == obj.id)
                    .all()
                )
