  ...
  <header class="hidden p-1 text-teal-100 bg-teal-800 md:flex">
    <div class="container flex justify-between h-16 mx-auto">
      ...
      <div class="relative">
        <button
          type="button"
          class="inline-flex items-center justify-center p-2 text-sm text-teal-600 rounded-lg hover:bg-teal-700 hover:text-gray-200 focus:outline-none focus:ring-0"
        ...
        {#if menuOpen}
          <div class="absolute right-0 z-50 w-48 mt-2 bg-white border border-teal-300 rounded-md shadow-lg">
            <a use:link href="/" class="block px-4 py-2 text-teal-600 hover:bg-teal-700 hover:text-gray-200">Home</a>
            <a use:link href="/aboutus" class="block px-4 py-2 text-teal-600 hover:bg-teal-700 hover:text-gray-200">About Us</a>
            <a use:link href="/services" class="block px-4 py-2 text-teal-600 hover:bg-teal-700 hover:text-gray-200">Services</a>
            <a use:link href="/contact" class="block px-4 py-2 text-teal-600 hover:bg-teal-700 hover:text-gray-200">Contact</a>
          </div>
        {/if}
      </div>
    </div>
