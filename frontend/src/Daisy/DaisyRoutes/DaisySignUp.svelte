<script>
  ...
  <div
    class="flex flex-col items-center justify-center h-full max-w-lg p-6 m-auto rounded-lg text-primary-content sm:p-10"
  >
    ...
    <form action="" class="w-full space-y-12">
      ...
      {:else if error}
        <div
          id="err-msg"
          class="w-full mx-auto font-bold text-center text-error"
        >
