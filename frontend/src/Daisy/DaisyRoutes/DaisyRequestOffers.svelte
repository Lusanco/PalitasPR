...
-->
<div
  class="flex flex-col items-center justify-center min-h-screen p-5 bg-base-100"
>
  <!-- 
    * Card 
  -->
        ...
        <figure class="mb-2 border-b-2">
          ...
          <div class="flex justify-between mt-2">
            ...
            <div class="relative mt-3 mr-2 dropdown-top">
              ...
              >
              <ul
                class="absolute z-10 hidden p-2 shadow menu dropdown-content bg-base-100 rounded-box w-52"
              >
                <li>
                  <a href="/"
                    ><i class="text-warning fa-solid fa-pencil"></i> Edit</a
                  >
                </li>
                <li>
                  <a href="/"
                    ><i class="text-error fa-solid fa-trash"></i>
