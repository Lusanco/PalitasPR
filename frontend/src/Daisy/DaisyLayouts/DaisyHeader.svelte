...
<!-- Header Start -->
  <header class="hidden p-1 text-primary-content bg-primary md:flex">
    <div class="container flex justify-between h-16 mx-auto mt-1">
      <Link name="" twcss="btn btn-ghost mt-2 normal-case text-xl" href="/">
        <svg
      ...
      <div class="flex items-center mx-2">
        <Link name="Sign in" twcss="px-6 mx-2 btn btn-outline-primary bg-base-100 hover:btn-primary shadow-md" href="/login" />
        <Link name="Sign up" twcss="px-8 btn btn-primary shadow-md" href="/signup"/>
      </div>
    </div>
  </header>
  <!-- Header End -->
