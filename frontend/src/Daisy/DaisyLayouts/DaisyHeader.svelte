<!-- Header Layout -->
<script>
    import Link from "../Daisycomponents/DaisyLink.svelte";
  ...
  <header class="hidden p-1 text-primary-content bg-primary md:flex">
    <div class="container flex justify-between h-16 mx-auto">
      <Link name="" twcss="btn btn-ghost normal-case text-xl" href="/">
        <svg
      ...
      <div class="flex items-center">
        <Link name="Login" twcss="btn btn-outline" href="/login" />
        <Link name="Sign up" twcss="btn btn-primary" href="/signup"/>
      </div>
    </div>
  </header>
  <!-- Header End -->
