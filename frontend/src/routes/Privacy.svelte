...
>
  <h1 class="text-4xl font-bold text-center text-stone-800">
  ...
  <br />
  <div>
    <h2 class="text-2xl font-semibold text-stone-800">4. Cookies</h2>
    <br />
    <p class="text-stone-700">
  ...
  <div>
    ...
    <br />
    <p class=" text-stone-700">Los usuarios tienen derecho a:</p>
    <ul class="mt-2 list-disc list-inside">
      <li>
        Acceder: Ver la información personal que hemos recopilado sobre ellos.
      </li>
      <li>
        Rectificar: Corregir cualquier información incorrecta o desactualizada.
      </li>
      <li>
  ...
  <br />
  <div>
    <h2 class="text-2xl font-semibold text-stone-800">6. Menores de Edad</h2>
    <br />
    <p class="text-stone-700">
  ...
  <br />
  <div>
    <h2 class="text-2xl font-semibold text-stone-800">7. Contacto</h2>
    <br />
    <p class=" text-stone-700">
  ...
  <div class="p-4 rounded-md shadow-md bg-stone-100">
    <p>
      ...
      graduación y actualmente no se aplica a una plataforma pública definitiva.
    </p>
  </div>
  <br />
